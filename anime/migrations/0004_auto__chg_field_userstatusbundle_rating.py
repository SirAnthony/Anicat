...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserStatusBundle.rating'
        db.alter_column('anime_userstatusbundle', 'rating', self.gf('django.db.models.fields.IntegerField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'UserStatusBundle.rating'
        db.alter_column('anime_userstatusbundle', 'rating', self.gf('django.db.models.fields.IntegerField')())
