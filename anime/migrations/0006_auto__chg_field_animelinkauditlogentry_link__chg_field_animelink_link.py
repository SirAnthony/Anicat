...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AnimeLinkAuditLogEntry.link'
        db.alter_column('anime_animelinkauditlogentry', 'link', self.gf('django.db.models.fields.URLField')(max_length=250))

        # Changing field 'AnimeLink.link'
        db.alter_column('anime_animelink', 'link', self.gf('django.db.models.fields.URLField')(max_length=250))


    def backwards(self, orm):
        
        # Changing field 'AnimeLinkAuditLogEntry.link'
        db.alter_column('anime_animelinkauditlogentry', 'link', self.gf('django.db.models.fields.URLField')(max_length=100))

        # Changing field 'AnimeLink.link'
        db.alter_column('anime_animelink', 'link', self.gf('django.db.models.fields.URLField')(max_length=100))
