...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AnimeLinksAuditLogEntry.action_user'
        db.alter_column('anime_animelinksauditlogentry', 'action_user_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

        # Changing field 'AnimeItemAuditLogEntry.action_user'
        db.alter_column('anime_animeitemauditlogentry', 'action_user_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

        # Changing field 'AnimeEpisodeAuditLogEntry.action_user'
        db.alter_column('anime_animeepisodeauditlogentry', 'action_user_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

        # Changing field 'AnimeLinkAuditLogEntry.action_user'
        db.alter_column('anime_animelinkauditlogentry', 'action_user_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

        # Changing field 'AnimeNameAuditLogEntry.action_user'
        db.alter_column('anime_animenameauditlogentry', 'action_user_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

        # Changing field 'PeopleBundleAuditLogEntry.action_user'
        db.alter_column('anime_peoplebundleauditlogentry', 'action_user_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

        # Changing field 'OrganisationAuditLogEntry.action_user'
        db.alter_column('anime_organisationauditlogentry', 'action_user_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

        # Changing field 'OrganisationBundleAuditLogEntry.action_user'
        db.alter_column('anime_organisationbundleauditlogentry', 'action_user_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

        # Changing field 'PeopleAuditLogEntry.action_user'
        db.alter_column('anime_peopleauditlogentry', 'action_user_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))


    def backwards(self, orm):
        
        # Changing field 'AnimeLinksAuditLogEntry.action_user'
        db.alter_column('anime_animelinksauditlogentry', 'action_user_id', self.gf('audit_log.models.fields.LastUserField')(null=True, to=orm['auth.User']))

        # Changing field 'AnimeItemAuditLogEntry.action_user'
        db.alter_column('anime_animeitemauditlogentry', 'action_user_id', self.gf('audit_log.models.fields.LastUserField')(null=True, to=orm['auth.User']))

        # Changing field 'AnimeEpisodeAuditLogEntry.action_user'
        db.alter_column('anime_animeepisodeauditlogentry', 'action_user_id', self.gf('audit_log.models.fields.LastUserField')(null=True, to=orm['auth.User']))

        # Changing field 'AnimeLinkAuditLogEntry.action_user'
        db.alter_column('anime_animelinkauditlogentry', 'action_user_id', self.gf('audit_log.models.fields.LastUserField')(null=True, to=orm['auth.User']))

        # Changing field 'AnimeNameAuditLogEntry.action_user'
        db.alter_column('anime_animenameauditlogentry', 'action_user_id', self.gf('audit_log.models.fields.LastUserField')(null=True, to=orm['auth.User']))

        # Changing field 'PeopleBundleAuditLogEntry.action_user'
        db.alter_column('anime_peoplebundleauditlogentry', 'action_user_id', self.gf('audit_log.models.fields.LastUserField')(null=True, to=orm['auth.User']))

        # Changing field 'OrganisationAuditLogEntry.action_user'
        db.alter_column('anime_organisationauditlogentry', 'action_user_id', self.gf('audit_log.models.fields.LastUserField')(null=True, to=orm['auth.User']))

        # Changing field 'OrganisationBundleAuditLogEntry.action_user'
        db.alter_column('anime_organisationbundleauditlogentry', 'action_user_id', self.gf('audit_log.models.fields.LastUserField')(null=True, to=orm['auth.User']))

        # Changing field 'PeopleAuditLogEntry.action_user'
        db.alter_column('anime_peopleauditlogentry', 'action_user_id', self.gf('audit_log.models.fields.LastUserField')(null=True, to=orm['auth.User']))
    ...
    models = {
        ...
        'anime.animelinksauditlogentry': {
            ...
            'action_id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'action_type': ('django.db.models.fields.CharField', [], {'max_length': '1'}),
            'action_user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'_animelinks_audit_log_entry'", 'null': 'True', 'to': "orm['auth.User']"}),
        ...
        'anime.userstatusbundle': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'rating': ('django.db.models.fields.IntegerField', [], {'default': '6', 'blank': 'True'}),
