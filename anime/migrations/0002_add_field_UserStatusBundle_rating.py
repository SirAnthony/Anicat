...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserStatusBundle.rating'
        db.add_column('anime_userstatusbundle', 'rating', self.gf('django.db.models.fields.IntegerField')(default=6), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserStatusBundle.rating'
        db.delete_column('anime_userstatusbundle', 'rating')
    ...
    models = {
        ...
        'anime.userstatusbundle': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'rating': ('django.db.models.fields.IntegerField', [], {'default': '6'}),
